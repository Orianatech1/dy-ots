...
@section('main-content')
       ...
       <div class="tech-abt-sec">
            ...
            <div class="tech-feature section-padding">
                <div class="container">
                    <div class="row">
                      <h3 class="mb-4" style="text-align: justify"> Our team of developers are well versed with the  following cutting edge technologies which are required to build a high level java applications.</br></br>
                      </h3>
