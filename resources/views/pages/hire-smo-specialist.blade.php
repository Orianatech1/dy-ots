...
@section('main-content')
        ...
        <section>
            ...
            <div class="tech-feature section-padding">
                <div class="container">
                    <div class="row">
                      <h3 class="mb-4" style="text-align: justify;">Our team of developers is well-versed with the cutting-edge technologies, which are essential for building high-level Social Media Optimization (SMO) solutions:</h3>
                      <div class="col-lg-12">
                        <div class="ul-icon white-tick">
                            <ul style="list-style-type:disc; text-align: justify;">
                                <li>
                                    <p><b>Content Strategy:</b></br></br>
                                ...
                                <li>
                                    <p><b>Engagement and Interaction:</b></br></br> Active Engagement:
                                ...
                                <li>
                                    <p ><b>Optimization and Analytics:</b></br></br>
                                ...
                                <li>
                                    <p><b>Cross-Platform Strategies:</b></br></br>
